...
public class HttpUtils2 {
     ...
     * @return
     */
    public static String postFile(String url, File file, String formName) {
        return postFile(url, formName, file);
//        return postFile(url, null, file);
    ...
    public static String postFile(String url, String name, File file) {
        try {
            HttpEntity reqEntity = MultipartEntityBuilder.create().addBinaryBody(name, file)
                .build();
